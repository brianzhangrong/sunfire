 ...
 */
public class KafkaClientSink extends AbstractSink implements Configurable {
    ...
    private static final Logger logger = LoggerFactory
            .getLogger(org.apache.flume.sink.kafka.KafkaSink.class);
    ...
    public Status process() throws EventDeliveryException {
        ...
        try {
            ...
            for (; processedEvents < batchSize; processedEvents += 1) {
                ...
                String keyHeader = queryHeader();
                headers.put(KEY_HEADER, keyHeader);
                ...
                if (logger.isTraceEnabled()) {
                    if (LogPrivacyUtil.allowLogRawData()) {
                        logger.trace(
                                "{Event} " + eventTopic + " : " + eventKey + " : " + new String(
                                        eventBody, "UTF-8"));
                    } else {
    ...
    private String queryHeader() throws Exception {
        return queryAppIp() + SunfireClientContants.HEADER_SPLIT + queryAppName();
    }

    private String queryAppName() {
        return SunfireClientContants.APP_NAME + SunfireClientContants.VALUE_SPLIT + appName;
    }

    private String queryAppIp() throws Exception {
        return SunfireClientContants.IP_HEADER + SunfireClientContants.VALUE_SPLIT + NetUtils
    ...
    public void configure(Context context) {
        appName = context.getString(SunfireClientContants.APP_NAME, "HelloSunfire");
        ...
        useAvroEventFormat = context
                .getBoolean(KafkaSinkConstants.AVRO_EVENT, KafkaSinkConstants.DEFAULT_AVRO_EVENT);
